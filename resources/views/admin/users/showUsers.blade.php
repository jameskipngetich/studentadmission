            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#uploadUserModal"><i class="fa fa-plus"></i>Upload File</button>
                        <div class="btn-group1" style="float:right">
                            ...
                            <a href="{{route('adminExportUsersAsPdf')}}" class="btn btn-sm btn-info">Export pdf</a>
                        </div>
                    </div>
                    <div class="card-body">
