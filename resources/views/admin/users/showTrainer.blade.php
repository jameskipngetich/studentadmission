...
<div class="container-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <H1 class="m-0 text-dark">Trainers</H1>
            </div>
            <div class="col-sm-6">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h6>Update Trainer</h6>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>

                                                    </div>
                                                   <form action="{{route('adminUpdateTrainers')}}" method="POST">
                                                           @csrf
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="text" name="is_Trainer" value="yes" class="form-control" hidden>
                                                    </div>
...
<div class="modal fade" id="addUserMOdal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{route('adminAddTrainers')}}">
                @csrf
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-6">
