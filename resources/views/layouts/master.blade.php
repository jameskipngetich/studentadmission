...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">tti</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">AdminHub</a>
        </div>
      </div>
      ...
      <!-- Sidebar Menu -->
          ...
          <li class="nav-item">
            <a href="{{route('adminShowClass')}}" class="nav-link">
              <i class="nav-icon fa fa-school text-danger"></i>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2024</a>.</strong> All rights reserved.
  </footer>
